    ...
    public class ExoContext : DbContext
    {
        ...
        optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                // optionsBuilder.UseMySQL("Server=localhost;Database=rodrigues;User=root;Password=@Dcrr57324698;");
                optionsBuilder.UseSqlServer("Server=localhost\\CLEILTON;Database=ExoApi;Trusted_Connection=True;");
